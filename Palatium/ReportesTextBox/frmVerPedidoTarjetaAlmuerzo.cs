...
{
    public partial class frmVerPedidoTarjetaAlmuerzo : Form
    {
        ConexionBD.ConexionBD conexion = new ConexionBD.ConexionBD();
        Clases.ClasePrecuentaTarjetaAlmuerzo precuenta = new Clases.ClasePrecuentaTarjetaAlmuerzo();
        ...
        public frmVerPedidoTarjetaAlmuerzo(string sIdOrden, int iCerrar)
        {
        ...
        private void frmVerPedidoTarjetaAlmuerzo_Load(object sender, EventArgs e)
        {
            verPrecuentaTextBox();
        ...
        private void frmVerPedidoTarjetaAlmuerzo_KeyDown(object sender, KeyEventArgs e)
        {
