...
{
    public partial class frmCierreCajaBar : Form
    {
        ...
        private void frmCierreCajaBar_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmCierreCajaBar_Load(object sender, EventArgs e)
        {
            agregarColumnas();
        }
