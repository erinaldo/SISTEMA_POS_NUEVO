...
namespace Palatium.Receta
{
    public partial class frmTemperatura : Form
    {
        ...
        public int iIdPostemperatura;
        int iModal;

        public frmTemperatura(int iModal_P)
        {
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                if (iModal == 1)
                {
                    sTabla = "pos_temperatura_de_servicio";
                    sCampo = "id_pos_temperatura_de_servicio";
                    ...
                    iIdPostemperatura = Convert.ToInt32(iMaximo);
                }
