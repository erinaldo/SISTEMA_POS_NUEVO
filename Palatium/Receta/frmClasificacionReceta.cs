...
namespace Palatium.Receta
{
    public partial class frmClasificacionReceta : Form
    {
        ...
        public int iIdPosClasificacion;
        int iModal;

        public frmClasificacionReceta(int iModal_P)
        {
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                if (iModal == 1)
                {
                    sTabla = "pos_clasificacion_receta";
                    sCampo = "id_pos_clasificacion_receta";
                    ...
                    iIdPosClasificacion = Convert.ToInt32(iMaximo);
                }
