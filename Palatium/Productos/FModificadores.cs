    ...
    public partial class FModificadores : Form
    {
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql += "id_pos_impresion_comanda, is_active, codigo_barra, imagen_categoria)" + Environment.NewLine;
                ...
                sSql += Convert.ToInt32(cmbDestinoImpresion.SelectedValue) + ", 1, '" + txtCodigoBarras.Text.Trim() + "," + Environment.NewLine;
                sSql += "'" + txtBase64.Text.Trim() + "')";
