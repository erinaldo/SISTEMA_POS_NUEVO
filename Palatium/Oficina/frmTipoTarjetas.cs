    ...
    public partial class frmTipoTarjetas : MaterialForm
    {
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "insert into pos_tipo_tarjeta (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "update pos_tipo_tarjeta set" + Environment.NewLine;
                sSql += "descripcion = '" + txtDescripcion.Text.Trim() + "'," + Environment.NewLine;
                sSql += "is_active = " + iHabilitado + Environment.NewLine;
                sSql += "where id_pos_tipo_tarjeta = " + iIdRegistro + Environment.NewLine;
                //sSql += "and estado = 'A'";
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql += "where id_pos_tipo_tarjeta = " + iIdRegistro;
